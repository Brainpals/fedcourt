...
foreach($linkr->getRecFrmQry("SELECT psn,CONCAT(surname, ' ', firstname, ' ', middlename) AS fullname,sex,gsmnumber,passport,openfileno,secretfileno,title,bgroup,dob,state,lga FROM payems_staff LIMIT 10") as $stmt){
